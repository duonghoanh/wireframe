import { View, Image, Text, TextInput, TouchableOpacity, Button, StyleSheet, Touchable } from "react-native";
...
const SignIn = () => {
  ...
  return (
    <View style={styles.viewContainer}>
      ...
      <View>
        <Text style={{ fontWeight: "bold", textAlign: "center", marginTop: 20,color:"#989EB1" }}>
          or you one of social profile.
        </Text>
      </View>
      <View style={styles.viewButtonApp}>
        <TouchableOpacity
          style={styles.buttonAppTweeter}
          >
